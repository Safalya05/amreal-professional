...
export const products: Product[] = [
  {
    ...
    image: img("1585232351009-aa87416fca90"),
    gallery: [
  ...
  },
  {
    ...
    gallery: [img("1522337360788-8b13dee7a37e"), img("1515377905703-c4788e51af15")],
  ...
  },
  {
    ...
    gallery: [img("1515377905703-c4788e51af15"), img("1522337360788-8b13dee7a37e")],
    hairTypes: ["Curly", "Damaged"],
  ...
  },
  {
    ...
    gallery: [img("1526047932273-341f2a7631f9"), img("1515377905703-c4788e51af15")],
  ...
  },
  {
    ...
    image: img("1519735777090-ec97162dc266"),
    gallery: [img("1519735777090-ec97162dc266"), img("1522337360788-8b13dee7a37e")],
  ...
  },
  {
    ...
    image: img("1526047932273-341f2a7631f9"),
    gallery: [img("1526047932273-341f2a7631f9"), img("1519735777090-ec97162dc266")],
    hairTypes: ["Straight", "Damaged"],
  ...
  },
  {
    ...
    image: img("1515377905703-c4788e51af15"),
    gallery: [img("1515377905703-c4788e51af15")],
    hairTypes: ["Straight", "Damaged"],
  ...
  },
  {
    ...
    image: img("1608248597279-f99d160bfcbc"),
    gallery: [img("1608248597279-f99d160bfcbc"), img("1585232351009-aa87416fca90")],
    hairTypes: ["Straight", "Curly"],
  ...
  },
  {
    ...
    image: img("1527799820374-dcf8d9d4a388"),
    gallery: [img("1527799820374-dcf8d9d4a388"), img("1608248597279-f99d160bfcbc")],
  ...
  },
  {
    ...
    gallery: [img("1516975080664-ed2fc6a32937"), img("1519735777090-ec97162dc266")],
    hairTypes: ["Straight", "Damaged"],
  ...
  },
  {
    ...
    image: img("1516975080664-ed2fc6a32937"),
    gallery: [img("1516975080664-ed2fc6a32937")],
    hairTypes: ["Straight", "Damaged"],
    concerns: ["Smoothing", "Damage", "Frizz"],
    ingredients: ["Formulation information to be supplied by AMREAL"],
    benefits: ["Professional format", "Smoothing-oriented routine"],
...
export const categories = [
  { name: "Haircare", description: "Professional everyday care.", image: img("1522337360788-8b13dee7a37e") },
  { name: "Hair Treatments", description: "Salon-focused treatment solutions.", image: img("1519735777090-ec97162dc266") },
  { name: "Scalp Care", description: "Focused scalp-care routines.", image: img("1608248597279-f99d160bfcbc") },
  { name: "Skincare", description: "Professional beauty essentials.", image: img("1515377905703-c4788e51af15") },
  { name: "Professional Essentials", description: "Formats designed for beauty businesses.", image: img("1526047932273-341f2a7631f9") }
];

export const hairTypes = [
  { name: "COLOURED", text: "Protect colour and maintain softness and shine.", image: img("1515377905703-c4788e51af15") },
  { name: "CURLY", text: "Care for texture, moisture and manageability.", image: img("1522337360788-8b13dee7a37e") },
  { name: "STRAIGHT", text: "Smooth, nourish and maintain healthy-looking hair.", image: img("1608248597279-f99d160bfcbc") },
  { name: "DAMAGED", text: "Restore, strengthen and improve manageability.", image: img("1519735777090-ec97162dc266") }
];

export const concerns = ["Hair Fall", "Frizz", "Dryness", "Damage", "Scalp", "Smoothing", "Nourishment", "Hair Spa"];

export const heroSlides = [
  { eyebrow: "SCIENCE FOR BEAUTIFUL HAIR.", title: "BEAUTY, REFINED.", text: "Professional beauty solutions designed for salons, beauty professionals and modern beauty businesses.", image: img("1515377905703-c4788e51af15") },
  { eyebrow: "PROFESSIONAL CARE.", title: "MORE THAN CARE.", text: "A product discovery experience built around professional routines and beautiful results.", image: img("1522337360788-8b13dee7a37e") },
  { eyebrow: "FORMULATED FOR PROFESSIONALS.", title: "THE BEAUTY RITUAL.", text: "Explore salon-focused formats, treatments and professional essentials.", image: img("1519735777090-ec97162dc266") },
  { eyebrow: "YOUR PROFESSIONAL BEAUTY PARTNER.", title: "BEAUTY IN PRACTICE.", text: "Discover the collection and start a conversation with AMREAL.", image: img("1608248597279-f99d160bfcbc") },
  { eyebrow: "AMREAL PROFESSIONAL.", title: "SCIENCE FOR BEAUTIFUL HAIR.", text: "Premium product discovery for modern beauty businesses.", image: img("1526047932273-341f2a7631f9") }
];